...
class DNASequence:
	...
	def trimm(self, three_bases):
		if self.target[:3] == three_bases and self.target[-3:] == three_bases[::-1]:
...
if __name__ == '__main__':
	...
	dna_seq.trimm(adapters)
	print(f"Trimmed target sequence: {dna_seq.target}")
